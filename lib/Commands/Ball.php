...
class Ball
{
    public function __invoke($who, $message, $type)
    {
        ...
        $response = [
            ...
            "Don't bet too much money on it!",
            "Definately!",
            "Definately not!",
            "Not a chance!",
            "This is an 8-ball, not a crystal ball...!",
            "Don't Hold Your Breath!",
            "Yes!",
            "No!",
            "Fat Chance!",
            "hold on, gotta take a ****",
            "I JUST FARTED!!",
            ...
            "I'm an 8-ball not a pool stick!",
            "ummmmmmm....whatever you say :)",
            "uhhhhh....sure!",
            "shut up",
            "I'm sick of questions! I'm gonna barf all over the person that asks me another question!",
            "Let me ask YOU a question: Don't you have sumthin better to do than sit around and talk to an imaginary "
            . "8-ball over the internet?",
            "f√ck no",
            "uhhh...hmmm...no??",
            "uhhh...hmmm..yes??",
