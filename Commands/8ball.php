...
${'8ball'} = function (int $who, array $message, int $type) {
    ...
    $response = [
        ...
        "All sources point to no!", "All sources point to yes!", "Don't bet too much money on it!", "Definately!",
        "Definately not!", "Not a chance!", "This is an 8-ball, not a crystal ball...!", "Don't Hold Your Breath!",
        "Yes!", "No!", "Fat Chance!", "hold on, gotta take a ****", "I JUST FARTED!!",
        ...
        "I know you love me ;)", "Go ask the 9-ball!", "Do I look like a cue ball?", "looks pretty good!",
        "looks pretty bad!", "Ofcourse!  How could it not be?", "How the hell would I know that?",
        "Not a chance on earth!", "Shouldn't you know this?...Sheesh!", "You're Dumb, go away", "Both!",
        ...
        "f√ck no", "uhhh...hmmm...no??", "uhhh...hmmm..yes??", "sure! uh huh! whatever!", "I'm running out of answers",
